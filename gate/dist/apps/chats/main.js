...
const _infractract_1 = __webpack_require__(90);
const chats_module_1 = __webpack_require__(107);
...
const user_auth_method_1 = __webpack_require__(84);
var Theme;
(function (Theme) {
    Theme["LIGHT"] = "light";
    Theme["DARK"] = "dark";
...
var schema_1 = __webpack_require__(101);
...
const config_1 = __webpack_require__(5);
const _shared_1 = __webpack_require__(14);
const factories_1 = __webpack_require__(95);
...
const process = __webpack_require__(97);
const path = __webpack_require__(98);
const dotenv_1 = __webpack_require__(99);
(0, dotenv_1.config)();
...
const swagger_1 = __webpack_require__(13);
const schema_1 = __webpack_require__(101);
...
const class_validator_1 = __webpack_require__(67);
const data_1 = __webpack_require__(102);
const class_transformer_1 = __webpack_require__(70);
var Schema;
(function (Schema) {
    let Service;
...
const common_1 = __webpack_require__(4);
const config_1 = __webpack_require__(5);
const bcrypt = __webpack_require__(105);
...
const common_1 = __webpack_require__(4);
const typeorm_1 = __webpack_require__(6);
const chats_service_1 = __webpack_require__(108);
const _domains_1 = __webpack_require__(7);
const chats_controller_1 = __webpack_require__(110);
const chats_repository_1 = __webpack_require__(109);
console.log(chats_repository_1.ChatsRepository);
let ChatsModule = class ChatsModule {
};
exports.ChatsModule = ChatsModule;
exports.ChatsModule = ChatsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([_domains_1.User, _domains_1.Messages, _domains_1.Chats])],
        providers: [chats_service_1.ChatsService, chats_repository_1.ChatsRepository],
...
exports.ChatsService = ChatsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof chats_repository_1.ChatsRepository !== "undefined" && chats_repository_1.ChatsRepository) === "function" ? _a : Object])
], ChatsService);
...
exports.ChatsRepository = ChatsRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(_domains_1.Chats)),
    __metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object])
], ChatsRepository);
...
__decorate([
    (0, microservices_1.MessagePattern)('chats.getAllByUser'),
...
__decorate([
    (0, microservices_1.MessagePattern)('chats.findById'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)('chats.create'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)('chats.update'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)('chats.delete'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
async function bootstrap() {
    ...
    await app.listen();
    console.log('Messages Microservice Chats (NATS Listener) is running...');
}
