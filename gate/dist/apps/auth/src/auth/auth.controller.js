...
let AuthController = class AuthController {
    ...
    async register(data) {
        return this.authService.register(data.res, data.body);
    }
    async login(data) {
        return this.authService.login(data.res, data.body);
    }
    async refresh(data) {
        return this.authService.refresh(data.res, data.authPayload);
    }
    async logout(data) {
